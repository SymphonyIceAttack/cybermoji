...
function getBlogName(lang: LanguageType): string {
  const names: Record<LanguageType, string> = {
    en: "duckinsview Blog - Instagram Tips, Guides & Privacy News",
    zh: "duckinsview 博客 - Instagram 技巧、指南和隐私资讯",
    fr: "Blog duckinsview - Conseils Instagram, guides et actualité confidentialité",
    es: "Blog de duckinsview - Consejos de Instagram, guías y noticias de privacidad",
    de: "duckinsview Blog - Instagram-Tipps, Anleitungen und Datenschutz-News",
    ja: "duckinsview ブログ - Instagram チップス、ガイド、プライバシー news",
    ko: "duckinsview 블로그 - Instagram 팁, 가이드 및 프라이버시 뉴스",
    pt: "Blog duckinsview - Dicas do Instagram, guias e notícias de privacidade",
    ru: "Блог duckinsview - Советы по Instagram, руководства и новости о конфиденциальности",
    ar: "مدونة duckinsview - نصائح إنستغرام وأدلة وأخبار الخصوصية",
  };
...
function getCollectionDescription(lang: LanguageType): string {
  const descriptions: Record<LanguageType, string> = {
    en: "Browse all articles from duckinsview. Learn about Instagram privacy, anonymous viewing, and content creation.",
    zh: "浏览 duckinsview 的所有文章。了解 Instagram 隐私、匿名浏览和内容创作。",
    fr: "Parcourez tous les articles de duckinsview. Apprenez la confidentialité Instagram, la visualisation anonyme et la création de contenu.",
    es: "Explora todos los artículos de duckinsview. Aprende sobre privacidad de Instagram, visualización anónima y creación de contenido.",
    de: "Durchsuchen Sie alle Artikel von duckinsview. Erfahren Sie mehr über Instagram-Datenschutz, anonymes Ansehen und Content-Erstellung.",
    ja: "duckinsview のすべての記事を閲覧。Instagram のプライバシー、匿名閲覧、コンテンツ作成について学びます。",
    ko: "duckinsview의 모든 기사를 탐색합니다. Instagram 프라이버시, 익명 시청, 콘텐츠 제작에 대해 알아보세요.",
    pt: "Navegue por todos os artigos do duckinsview. Aprenda sobre privacidade do Instagram, visualização anônima e criação de conteúdo.",
    ru: "Просмотрите все статьи duckinsview. Узнайте о конфиденциальности Instagram, анонимном просмотре и создании контента.",
    ar: "تصفح جميع مقالات duckinsview. تعرف على خصوصية إنستغرام والمشاهدة المجهولة الهوية وإنشاء المحتوى.",
  };
  return descriptions[lang] || descriptions.en;
}
    ...
    en: [
      {
        ...
        author: { "@type": "Organization", name: "duckinsview" },
        publisher: { "@type": "Organization", name: "duckinsview" },
        mainEntityOfPage: {
          "@type": "WebPage",
