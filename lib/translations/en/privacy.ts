export const privacy = {
  ...
  "privacy.essentialCookiesList1": "Remembering your language preference",
  "privacy.essentialCookiesList2": "Maintaining session security",
  "privacy.essentialCookiesList3": "Enabling core site features and navigation",
  "privacy.thirdPartyCookiesTitle": "Third-Party Advertising Cookies",
  "privacy.thirdPartyCookiesDesc":
    "Google AdSense and Third-Party Vendors: Third-party vendors, including Google, use cookies to serve ads based on users' prior visits to our website or other websites.",
  "privacy.optOutLink": "www.aboutads.info/choices",
  "privacy.analyticsCookiesTitle": "Analytics Cookies",
  "privacy.analyticsCookiesDesc":
    "We may use analytics tools to understand how users interact with our website. These tools collect information anonymously and help us improve our service.",
  "privacy.consentManagementTitle": "Consent Management",
  ...
  "privacy.generalRightsList3":
    "Right to Opt-Out - Disable analytics tracking through browser settings",
  "privacy.generalRightsList4":
    "Right to Restrict - Limit how we process your data",
  "privacy.gdprRightsTitle": "GDPR Rights (EEA and UK Users)",
  ...
  "privacy.gdprRightsList1": "Right to access your personal data",
  "privacy.gdprRightsList2": "Right to rectification of inaccurate data",
  "privacy.gdprRightsList3": "Right to erasure (right to be forgotten)",
  "privacy.gdprRightsList4": "Right to restrict data processing",
  ...
  "privacy.disclaimerLink": "Disclaimer",
} as const;
