export const privacy = {
  ...
  "privacy.essentialCookiesList1": "تذكر تفضيل اللغة الخاص بك",
  "privacy.essentialCookiesList2": "الحفاظ على أمان الجلسة",
  "privacy.essentialCookiesList3": "تمكين ميزات الموقع الأساسية والتنقل",
  ...
  "privacy.generalRightsList3":
    "حق الانسحاب - تعطيل تتبع التحليلات من خلال إعدادات المتصفح",
  "privacy.generalRightsList4": "حق التقييد - تحديد كيفية معالجة بياناتك",
  ...
  "privacy.gdprRightsDesc":
    "إذا كنت موجوداً في المنطقة الاقتصادية الأوروبية أو المملكة المتحدة، فأنت لديك حقوق إضافية بموجب اللائحة العامة لحماية البيانات:",
