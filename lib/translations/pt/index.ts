...
const isValid = validateTranslations(ptFlat, "pt");
if (!isValid) {
  console.warn(
    "[i18n] Portuguese (pt) translations have some missing or extra keys - this is expected if not all languages are fully translated",
  );
}
