export const privacy = {
  ...
  "privacy.section3List1": "모든 연결은 SSL/TLS(HTTPS)를 사용하여 암호화됩니다",
  "privacy.section3List2": "검색 기록이나 브라우징 데이터를 저장하지 않습니다",
  "privacy.section3List3": "정기적인 보안 감사 및 업데이트",
  "privacy.section3List4": "사용자 세션의 영구 저장소 없음",
  "privacy.section4Title": "4. 서드파티 서비스",
  ...
  "privacy.section4List2": "분석 - 서비스를 개선하기 위한 익명 사용 통계",
  "privacy.section4List3": "호스팅 - 안전한 클라우드 인프라",
  ...
  "privacy.section5Title": "5. 쿠키 및 광고",
  ...
  "privacy.analyticsCookiesDesc":
    "사용자가 당사 웹사이트와 어떻게 상호작용하는지 이해하기 위해 분석 도구를 사용할 수 있습니다. 이 도구는 익명으로 정보를 수집합니다.",
  ...
  "privacy.section7Title": "7. 귀하의 권리",
