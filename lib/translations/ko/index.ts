...
// Validate Korean translations
const isValid = validateTranslations(koFlat, "ko");
if (!isValid) {
  console.warn(
    "[i18n] Korean (ko) translations have some missing or extra keys - this is expected if not all languages are fully translated",
  );
}
