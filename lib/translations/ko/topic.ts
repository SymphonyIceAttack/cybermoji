export const topic = {
  ...
  "topic.name.cat": "고양이",
  "topic.name.dog": "강아지",
  "topic.storyline.badge": "발견",
  "topic.storyline.feature1Title": "아름다운 디자인",
  "topic.storyline.feature1Desc": "모든 기분에 맞는 수제 이모지 조합",
  "topic.storyline.feature2Title": "자신을 표현하세요",
  "topic.storyline.feature2Desc": "감정을 전달하는 완벽한 방법을 찾으세요",
  "topic.storyline.feature3Title": "즉시 복사",
  "topic.storyline.feature3Desc": "한 번의 클릭으로 복사하여 어디에나 사용",
  "topic.storyline.feature4Title": "언제나 신선함",
  "topic.storyline.feature4Desc": "정기적으로 새 조합 추가",
  "topic.faq.badge": "FAQ",
  ...
  "topic.faq.a1": "임의의 이모지 조합을 클릭하여 클립보드에 복사하면 됩니다. 채팅, 소셜 미디어, 이메일 등 어디에나 붙여넣을 수 있습니다.",
  "topic.faq.q2": "소셜 미디어에서 사용할 수 있나요?",
  "topic.faq.a2": "네! 이것들은 Twitter, Facebook, Instagram, TikTok 및 대부분의 다른 플랫폼에서 작동하는 표준 유니코드 문자입니다.",
  "topic.faq.q3": "모바일 기기에서 작동하나요?",
  "topic.faq.a3": "물론입니다! 이 이모지는 iPhone, Android 및 모든 최신 모바일 브라우저와 앱에서 작동합니다.",
  "topic.faq.q4": "좋아하는 조합을 저장하려면 어떻게 해야 하나요?",
  "topic.faq.a4": "임의의 조합을 길게 눌러 즐겨찾기에 추가합니다. 즐겨찾기는 빠른 접근을 위해 저장됩니다.",
  "topic.faq.q5": "한 번에 여러 조합을 복사할 수 있나요?",
  "topic.faq.a5": "네! 길게 눌러 여러 조합을 선택한 다음 한 번에 모두 복사합니다.",
  "topic.faq.q6": "이 이모지는 무료로 사용할 수 있나요?",
  "topic.faq.a6": "네! 모든 이모지는 표준 유니코드 문자이며 어디에서나 완전히 무료로 사용할 수 있습니다.",
} as const;
